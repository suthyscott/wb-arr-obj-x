...
function removeItem (myGroceryList, item){
  ...
  if(!myGroceryList || !item){
    console.log('bad', myGroceryList, item)
    return []
  } else {
    console.log('good', myGroceryList, item)
...
devMountainEmployees.push(ryan, colt, cahlan, joe)
